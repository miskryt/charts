...
<div class="filter-buttons float-left">
  <button type="button" class="btn btn-grey btn-outline-secondary float-left" id="toggle_filter_table0" title="Filters" data-column="filters">
  ...
  <button type="button" class="btn btn-grey btn-outline-secondary" id="reset_filter_table0" title="Filters" data-column="filters">
...
<div class="table-block float-left">
  <table class="display nowrap table table-striped table-hover table_filtered" id="table0">
