...
<div class="filter-buttons float-left">
  <button type="button" class="btn btn-grey btn-outline-secondary float-left" id="toggle_filter_0" title="Filters" data-column="filters">
  ...
  <button type="button" class="btn btn-grey btn-outline-secondary" id="reset_filter_0" title="Filters" data-column="filters">
